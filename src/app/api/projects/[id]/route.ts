...
export async function PATCH(
  ...
  try {
    ...
    // NHÁNH 1: NẾU LÀ ACTION CẬP NHẬT THÔNG TIN CHI TIẾT
    if (body.action === "UPDATE_DETAILS") {
      ...
      await prisma.projectHistory.create({
        data: { projectId, note: "Cập nhật thông tin chi tiết dự án" }
      });
    ...
    // NHÁNH 2: NẾU LÀ CẬP NHẬT TIẾN ĐỘ (Giữ nguyên logic cũ của bạn)
